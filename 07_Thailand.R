#' ---
#' title: "Thailand Analysis Script"
...
#' Sixteen points in other crop exist as understory. 
#' Will exclude, as it's already included in the agroforestry landuse by default.  
