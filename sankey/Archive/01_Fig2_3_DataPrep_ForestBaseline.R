...
rawData$Ecofloristic <- rawData$code_name
noEco <- rawData[rawData$Ecofloristic=="",]

#rawData$Ecofloristic[rawData$LAND_USE_1 != 'Natural_Forest']<-'NotForest'
#rawData$code_name[rawData$LAND_USE_1 != 'Natural_Forest']<-'NotForest'
...
rawData <- mutate(rawData, Ecofloristic = case_when(
  # Assign not tree cover
  (LAND_USE_1 != 'Natural_Forest') ~ 'NotForest',
  # Others are tree cover
...
rawData <- mutate(rawData, TreeCover_2000 = case_when(
  ...
  # Assign not tree cover
  (LAND_USE_1 == 'Forest_Commodity') ~ 'Forest_Commodity',
  # Others are tree cover
  TRUE ~ 'Tree cover'
)
)
...
unique(rawData$LossType[rawData$LAND_USE_1 == 'Forest_Commodity'])
unique(rawData$LossType[rawData$LAND_USE_1 == 'Other_LAND_USE_YEAR_2000'])
unique(rawData$LossType[rawData$LAND_USE_1 == 'Natural_Forest'])
