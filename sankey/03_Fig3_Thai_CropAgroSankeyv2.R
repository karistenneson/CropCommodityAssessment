...
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Herb']<-146150
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Oil_']<-93724
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Pulp']<-170790
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Tree']<-55125
