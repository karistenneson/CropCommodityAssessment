...
SourceTotalsAll
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Crop']<-21127
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Frui']<-39622
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Shru']<-15625
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Tree']<-99708
