...
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Oil_']<-91799
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Shru']<-3847
...
my_colorNoLink <- paste0('d3.scaleOrdinal() .domain([', 
                         ...
                         '"TR", "Dec", "TDry", "TMS", "TCrop", "PCrop", "SCrop", "HCrop", "CropSup",  
                         "Boundary", "Mono", "Silvi",
                         "Herb", "Palm", "Trad", "Agrisil", "Shrub", "Bndry", "Crop_support", "Tree"',
                         ']) .range([', 
                         #add in node colors
                         #'"TR",     "Dec",  "TDry",  "TMS",  "TCrop","PCrop","SCrop","HCrop", "CropSup",     
                         '"darkgreen","#03BB85","black", "#03BB85","#5E1914","#BE5504","gold","yellow","#996515",',
                         #"Boundary", "Mono", "Silvi"
