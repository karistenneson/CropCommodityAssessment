...
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Herb']<-253915
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Crop']<-6804
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Pulp']<-89759
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Rubb']<-102708
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Shru']<-4344
