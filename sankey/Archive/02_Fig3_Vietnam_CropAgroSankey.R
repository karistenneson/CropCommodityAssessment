...
SourceTotalsAll
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Crop']<-20785
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Rubb']<-63206
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Shru']<-15621
...
nodesAll$group[substr(nodesAll$name, 1, 12)=="Tropical shr"] <- "TShrb"
