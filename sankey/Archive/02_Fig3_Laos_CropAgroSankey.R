...
SourceTotalsAll
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Pulp']<-87250
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Tree']<-34802
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Shru']<-4221
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Rice']<-1376
...
nodesAll$group <- recode(substr(nodesAll$name, 1, 5), 
                      "Agris" = "AgSil",
                      "Aquac" = "HCrop",
                      "Bound" = "Bndry",
                      "Cocon" = "PCrop",
...
my_colorNoLink <- paste0('d3.scaleOrdinal() .domain([', 
                         ...
                         '"TR", "TMS", "Dec", "SubT", "TCrop", "PCrop", "SCrop", "HCrop", "CropSup",  
                         "Boundary", "Mono", "Silvi",
                         "Herb", "Trad", "Agrisil", "Shrub", "Bndry", "Crop_support", "Tree"',
                         ']) .range([', 
                         #add in node colors
                         #'"TR",     "TMS",     "Dec",  "SubT",   "TCrop","PCrop","SCrop","HCrop", "CropSup",     
                         '"darkgreen","#93CB56","#03BB85","black", "#5E1914","#BE5504","gold","yellow","#996515",',
                         #"Boundary", "Mono", "Silvi"
                         '"purple", "grey",   "darkgreen",',
                         #"Herb",  "Trad",      "Agrisil","Shrub", "Bndry", "Crop_support","Tree"',
                         '"#FFD300","lightgrey","#B8BC86","gold",  "#E54ED0", "#996515",     "#A45A52"',
                         '])')
