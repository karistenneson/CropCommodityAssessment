...
rawData$ForestDynamics[rawData$LAND_USE_Y == 'Natural Forest' & rawData$LAND_USE == 'Natural Forest'] <- 'stable'
rawData$ForestDynamics[rawData$LAND_USE_Y == 'Natural Forest' & rawData$LAND_USE != 'Natural Forest'] <- 'loss'
rawData$ForestDynamics[rawData$LAND_USE_Y != 'Natural Forest'] <- 'Not Forest'

## update forest loss transition type
rawData$LossType <- 'None'
...
rawData$LossType[rawData$ForestDynamics == 'loss' & rawData$LAND_COVER == 'Water'] <- 'Forest_to_Water'

unique(rawData[rawData$Transition == 'Forest_to_Barren', c('LAND_COVER', 'LAND_USE')])
rawData$LossType[rawData$ForestDynamics == 'loss' & rawData$LAND_COVER == 'Non-vegetated'] <- 'Forest_to_Barren'
...
unique(rawData$LAND_COVER[(rawData$Transition == 'Forest_to_Agriculture' & rawData$LAND_USE == 'Plantation')]) 
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Oil Palm' 
                  & (rawData$LAND_USE == 'Plantation' | rawData$LAND_USE == 'Mixed Agrisilviculture' | rawData$LAND_USE == 'Agrisiviculture')
                  )]<- 'Oil_Palm'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Rubber' 
                  & rawData$LAND_USE == 'Plantation')]<- 'Rubber_Crop'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Other Tree' 
                  & (rawData$LAND_USE == 'Plantation' | rawData$LAND_USE == 'Mixed Agrisilviculture' | rawData$LAND_USE == 'Agrisiviculture')
                  )]<- 'Tree_Crop'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Other Tree' 
                  & (rawData$LAND_USE == 'Boundary Agrisilviculture'))]<- 'Boundary_Tree_Crop'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Other Palm' 
                  & (rawData$LAND_USE == 'Plantation' | rawData$LAND_USE == 'Mixed Agrisilviculture' | rawData$LAND_USE == 'Agrisiviculture')
                  )]<- 'Palm_Crop'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Coconut' 
                  & (rawData$LAND_USE == 'Plantation' | rawData$LAND_USE == 'Mixed Agrisilviculture' | rawData$LAND_USE == 'Agrisiviculture')
                  )]<- 'Coconut_Crop'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Pulpwood' 
                  & (rawData$LAND_USE == 'Plantation' | rawData$LAND_USE == 'Mixed Agrisilviculture'))]<- 'Pulpwood_Crop'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Fruit/Nut' 
...
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Herbaceous' 
                  & rawData$LAND_USE == 'Plantation')]<- 'Plantation_ground_Cover'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Other Crop' 
                  & rawData$LAND_USE == 'Plantation')]<- 'Other_crop'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Other' 
                  & rawData$LAND_USE == 'Plantation')]<- 'Plantation_support'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Non-vegetated' 
                  & rawData$LAND_USE == 'Plantation')]<- 'Plantation_support'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Built-up' 
                  & rawData$LAND_USE == 'Plantation')]<- 'Plantation_support'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Other Shrub' 
...
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Coffee' 
                  & (rawData$LAND_USE == 'Mixed Agrisilviculture' | rawData$LAND_USE == 'Agrisiviculture' | rawData$LAND_USE == 'Terrace')
                  )]<- 'Coffee_crop'
rawData$CropType[(rawData$LossType == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Rice' 
                  & (rawData$LAND_USE == 'Mixed Agrisilviculture' | rawData$LAND_USE == 'Agrisiviculture' | rawData$LAND_USE == 'Terrace' 
                     | rawData$LAND_USE == 'Other')
                  )]<- 'Rice_crop'
rawData$CropType[(rawData$ForestDynamics == 'Forest_to_Agriculture' & rawData$LAND_COVER == 'Aquaculture')]<- 'Aquaculture'

# to built up
unique(rawData[rawData$Transition == 'Forest_to_BuiltUp', c('LAND_COVER', 'LAND_USE')])
rawData$LossType[rawData$ForestDynamics == 'loss' & rawData$LAND_COVER == 'Built-up'& 
                   rawData$LossType != 'Forest_to_Agriculture'] <- 'Forest_to_BuiltUp'
# to other
unique(rawData[(rawData$Transition == 'Forest_to_Other'), c('LAND_COVER', 'LAND_USE')])
rawData$LossType[rawData$ForestDynamics == 'loss' & rawData$LAND_COVER == 'Other' & 
                   rawData$LossType != 'Forest_to_Agriculture'] <- 'Forest_to_Other'
# to other shrub
unique(rawData[rawData$Transition == 'Forest_to_Shrub', c('LAND_COVER', 'LAND_USE')])
rawData$LossType[rawData$ForestDynamics == 'loss' & rawData$LAND_COVER == 'Other Shrub' & 
                   rawData$LossType != 'Forest_to_Agriculture'] <- 'Forest_to_Veg'
# to other herb
unique(rawData[rawData$Transition == 'Forest_to_Herb', c('LAND_COVER', 'LAND_USE')])
rawData$LossType[rawData$ForestDynamics == 'loss' & rawData$LAND_COVER == 'Herbaceous'& 
                   rawData$LossType != 'Forest_to_Agriculture'] <- 'Forest_to_Veg'
# to other bamboo or tree
unique(rawData[rawData$Transition == 'Forest_to_OtherTree', c('LAND_COVER', 'LAND_USE')])
rawData$LossType[rawData$ForestDynamics == 'loss' & (rawData$LAND_COVER == 'Bamboo' |rawData$LAND_COVER == 'Other Tree') & 
                   rawData$LossType != 'Forest_to_Agriculture'] <- 'Forest_to_Veg'

# to Silvopastoral 
unique(rawData[rawData$Transition == 'Forest_to_Agriculture' & rawData$LAND_USE == 'Silvopastoral', c('LAND_COVER', 'LAND_USE')])
rawData$LossType[(rawData$ForestDynamics == 'loss' & rawData$LAND_USE == 'Silvopastoral')] <- 'Forest_to_Silvopastoral'
...
questions <-  c("LAND_COVER", "UNDERSTORY",
                "LAND_USE", "LAND_USE_Y", "Ecofloristic", "Transition", "ForestLoss")
...
qstn <- headerOfInterest<-'LossType'
