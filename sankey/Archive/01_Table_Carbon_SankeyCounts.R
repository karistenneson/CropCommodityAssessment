...
country<-"Philippines"
stratumAreas <- stratumAreasPhil
sampSize <- sampSizePhil
...
qstn <- headerOfInterest<-'Forest_CropSys'
...
coverArea
write.csv(coverArea, paste0('Results/Table_Carbon/Table_Carbon_', country, 'ForesttoCropSys.csv'))
