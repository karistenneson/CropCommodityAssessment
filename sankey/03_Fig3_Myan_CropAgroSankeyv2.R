...
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Crop']<-17910
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Oil_']<-16829
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Rubb']<-56534
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Rice']<-9500
