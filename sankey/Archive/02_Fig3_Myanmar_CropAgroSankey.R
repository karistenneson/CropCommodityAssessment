...
SourceTotalsAll
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Crop']<-17901
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Rubb']<-56497
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Shru']<-3547
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Rice']<-10443
...
my_colorNoLink <- paste0('d3.scaleOrdinal() .domain([', 
                         ...
                         '"TR", "TMS", "Dec", "TDry", "SubT", "TCrop", "PCrop", "SCrop", "HCrop", "CropSup",  
                         "Boundary", "Mono", "Silvi",
                         "Herb", "Palm", "Trad", "Agrisil", "Shrub", "Bndry", "Crop_support", "Tree"',
                         ']) .range([', 
                         #add in node colors
                         #'"TR",     "TMS",     "Dec",  "TDry", "SubT",   "TCrop","PCrop","SCrop","HCrop", "CropSup",     
                         '"darkgreen","#93CB56","#03BB85","black","black", "#5E1914","#BE5504","gold","yellow","#996515",',
                         #"Boundary", "Mono", "Silvi"
