...
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Coff']<-21714
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Herb']<-91430
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Rubb']<-64849
#SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Tree']<-63707
