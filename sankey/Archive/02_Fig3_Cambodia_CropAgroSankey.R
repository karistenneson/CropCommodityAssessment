...
SourceTotalsAll
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Crop']<-20624
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Pulp']<-13762
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Tea_']<-11208
SourceTotalsAll$Source_Total[SourceTotalsAll$name == 'Shru']<-15250
...
TargetTotalsAll$LinkGroup[substr(TargetTotalsAll$name,1,3) %in% c("Ban", 'Coc',"Oil", "Pal")]<-'Palm'
...
my_colorNoLink <- paste0('d3.scaleOrdinal() .domain([', 
                         ...
                         '"TR", "Dec", "TDry", "TCrop", "PCrop", "SCrop", "HCrop", "CropSup",  
                         "Boundary", "Mono", "Silvi",
                         "Herb", "Palm", "Trad", "Agrisil", "Shrub", "Bndry", "Crop_support", "Tree"',
                         ']) .range([', 
                         #add in node colors
                         #'"TR",     "Dec",  "TDry",   "TCrop","PCrop","SCrop","HCrop", "CropSup",     
                         '"darkgreen","#03BB85","black", "#5E1914","#BE5504","gold","yellow","#996515",',
                         #"Boundary", "Mono", "Silvi"
